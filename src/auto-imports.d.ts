...
export {}
declare global {
  const AIChatWindow: typeof import('./components/apps/AIChatWindow')['default']
  const AIChatbot: typeof import('./components/apps/AIChatbot')['default']
  ...
  const BearApp: typeof import('./components/apps/BearApp')['default']
  const BearProfile: typeof import('./components/apps/SahilProfile')['default']
  const BearProjects: typeof import('./components/apps/SahilProjects')['default']
  ...
  const MonacoEditor: typeof import('./components/apps/MonacoEditor')['default']
  const ResumeFolder: typeof import('./components/apps/ResumeFolder')['default']
  const Safari: typeof import('./components/apps/Safari')['default']
  const SahilProfile: typeof import('./components/apps/SahilProfile')['default']
  const SahilProjects: typeof import('./components/apps/SahilProjects')['default']
  const Siri: typeof import('./components/apps/Siri')['default']
  const SpinningCat: typeof import('./components/apps/SpinningCat')['default']
